...
function Home(){
    return(
        <section className="min-h-screen">
            ...
            <Link to={'/products'} className="px-6 text-4xl py-3 bg-purple-400 hover:bg-purple-600 hover:text-white absolute top-[450px] right-[230px]" >Browse all Products</Link>
        </section>
    )
}
